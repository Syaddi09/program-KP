  ...
  <div class="container">
    <div class="row login-container">
      ...
      <div class="col-md-6">
        ...
        <form class="login-form" action="proses_add_daftar.php" class="sign-up-form" method="POST">
          ...
          <div class="mb-3">
          <input type="hidden" placeholder="Username" value="2" name="id_level_user" id="id_level_user" />
                    </div>
