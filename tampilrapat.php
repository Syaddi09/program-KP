...
// Mengambil data dari tabel dt_rapat
$query = "SELECT * FROM dt_rapat";
...
<head>
  ...
  <title>Admin Dashboard - Tampil Rapat</title>
...
<div class="container-fluid">
  <div class="row">
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column ml-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="tampilrapat.php">
              Sewa Tempat Rapat
            </a>
          </li>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <h1 class="mt-4">Data Sewa Tempat Rapat</h1>
      <p>Dibawah ini adalah data sewa tempat rapat:</p>
      <div class="container">
        <table class="table">
          <thead>
            <tr>
        ...
        <button id="approveAllBtn" class="btn btn-success">Cetak Laporan</button>
      </div>
    </main>
  </div>
</div>
...
$(document).ready(function(){
  $(".approveBtn").click(function(){
    var id = $(this).data('id');
    $.post("updateStatusRapat.php", {id:id, status:"Approve"}, function(data){
      location.reload();
    });
  });
  ...
  $(".rejectBtn").click(function(){
    var id = $(this).data('id');
    $.post("updateStatusRapat.php", {id:id, status:"Reject"}, function(data){
      location.reload();
    });
  });
});
