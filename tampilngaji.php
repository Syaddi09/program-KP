    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column ml-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="tampilngaji.php">
              Privat Mengaji
            </a>
          </li>
          <li class="nav-item">
...
$(document).ready(function(){
  $(".approveBtn").click(function(){
    var id = $(this).data('id');
    $.post("updateStatusNgaji.php", {id:id, status:"Approve"}, function(data){
      location.reload();
    });
  });
  ...
  $(".rejectBtn").click(function(){
    var id = $(this).data('id');
    $.post("updateStatusNgaji.php", {id:id, status:"Reject"}, function(data){
      location.reload();
    });
  });
});
